...
public class SecurePlayerPrefs
{
   ...
   */
    private static readonly string PRIVATE_KEY_PREFIX = "gghe";
    private static readonly string PRIVATE_KEY_RAND = "ern";
    private static readonly string PRIVATE_KEY_SUFFIX = "y";
    ...
    private static readonly string RAND_KEY = "plfthgfc";
